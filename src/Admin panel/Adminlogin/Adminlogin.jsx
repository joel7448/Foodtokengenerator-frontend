...
const formik = useFormik({
    ...
    onSubmit:async(values)=>{
      try{
      const login =await axios.post(`${config().api}/server/admin/signin`,values);
...
<p>New to Amigos | <Link className='link' to="/admin/register">Signup</Link></p>
<p>Click on User to open<Link className="link" to="/login"> User portal</Link></p>
</div>
