...
const navigate = useNavigate();
    const formik = useFormik({
        ...
        onSubmit:async(values)=>{
         try{
          const  register = await axios.post(`${config().api}/server/admin/register`,values)
...
<p className="login-redirect">Already an admin | <Link className="link" to="/admin/login">Login</Link></p>
</div>
